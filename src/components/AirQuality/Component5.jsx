...
const Component5 = () => {
  ...
  return (
    <div className="C3-container-mobile flex flex-col gap-3 m-6 rounded-2xl">
      <div className="C3-txt-mobile">
        <div className="C3-heading-mobile flex flex-row items-center gap-2">
        ...
        <div className="select-mobile flex flex-col gap-4">
          <select
